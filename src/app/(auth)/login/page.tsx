...
function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md bg-black/40 backdrop-blur-md border-white/10 text-white shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black/50 text-white placeholder:text-gray-500"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-black/50 text-white"
                placeholder="••••••••"
              />
              <button
                type="button"
