    ...
    <div className="p-3 md:p-6 max-w-5xl mx-auto">
      ...
      {status && (() => {
        ...
        if (isConnected) {
          ...
          description = `Nomor: ${status.phoneNumber || 'Terhubung'} (Kondisi HEALTHY / NORMAL)`;
        ...
        return (
          <div className={`mb-6 p-4 rounded-xl shadow-sm border-2 flex items-center justify-between transition-all duration-500 ${bgColor}`}>
            <div className="flex items-center space-x-4">
              <div className={`w-14 h-14 rounded-xl flex items-center justify-center border-2 shadow-sm transition-transform duration-500 hover:scale-105 ${iconBg} ${isConnected || isReconnecting ? 'animate-pulse border-current' : 'border-red-200'}`}>
            ...
            <div className={`p-1 flex items-center justify-center rounded-md border shadow-sm ${bgColor.replace('bg-', 'border-').replace('-50', '-200')} ${animateClass}`}>
