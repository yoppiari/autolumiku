      ...
      <div className={`p-4 md:p-5 rounded-xl shadow-md border-2 mb-4 md:mb-6 flex-shrink-0 transition-all ${status.isConnected
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center space-x-3">
            <div className={`w-12 h-12 flex-shrink-0 rounded-full flex items-center justify-center overflow-hidden border-2 ${status.isConnected ? 'border-green-400 bg-green-100' : 'border-yellow-400 bg-yellow-100'
              }`}>
