...
export default function WhatsAppAIDashboard() {
  ...
  const getStatusBgColor = (isConnected: boolean) => {
    return isConnected
      ? 'bg-gradient-to-r from-green-900/30 to-emerald-900/30 border-green-800'
      : 'bg-gradient-to-r from-yellow-900/30 to-amber-900/30 border-yellow-800';
  };
    ...
    <div className="p-4 md:p-6 h-[calc(100vh-64px)] flex flex-col overflow-hidden">
      ...
      <div className="mb-2 md:mb-3 flex-shrink-0 pl-10 md:pl-0 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-[10px] md:text-sm mt-0.5">Asisten virtual 24/7 untuk customer dan staff operations</p>
        </div>
      </div>
            ...
            <div className="min-w-0">
              ...
              {status.isConnected ? (
                <div className="text-xs text-gray-400 flex items-center flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-1.5 bg-[#2a2a2a] px-2 py-0.5 rounded border border-green-800">
                    <svg className="w-3 h-3 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                    </svg>
                    <span className="font-bold text-green-500">{status.phoneNumber}</span>
                  </div>
                  <a
                    href={`https://wa.me/${status.phoneNumber?.replace(/\D/g, '')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[10px] text-blue-400 hover:underline flex items-center gap-1 ml-1"
                  >
                    Open Chat ↗
                  </a>
      ...
      <div className="flex-1 overflow-auto">
        ...
        {status.isConnected && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-3 md:mb-4">
            <Link
              ...
              className="group bg-[#2a2a2a] p-3 md:p-4 rounded-xl shadow-sm border-2 border-[#3a3a3a] hover:border-blue-700 hover:shadow-md transition-all transform hover:-translate-y-1"
            >
              <div className="flex items-center gap-3">
                <div className="text-3xl md:text-4xl">💬</div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-sm md:text-base text-gray-100 group-hover:text-blue-400 transition-colors mb-0.5 truncate">
                    Conversations
                  </h3>
                  <p className="text-[10px] md:text-xs text-gray-400 leading-tight line-clamp-1">
            ...
            <Link
              ...
              className="group bg-[#2a2a2a] p-3 md:p-4 rounded-xl shadow-sm border-2 border-[#3a3a3a] hover:border-purple-700 hover:shadow-md transition-all transform hover:-translate-y-1"
            >
              <div className="flex items-center gap-3">
                <div className="text-3xl md:text-4xl">📊</div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-sm md:text-base text-gray-100 group-hover:text-purple-400 transition-colors mb-0.5 truncate">
                    Analytics
                  </h3>
                  <p className="text-[10px] md:text-xs text-gray-400 leading-tight line-clamp-1">
                    Performance metrics
            ...
            <Link
              href="/dashboard/whatsapp-ai/config"
              className="group bg-[#2a2a2a] p-3 md:p-4 rounded-xl shadow-sm border-2 border-[#3a3a3a] hover:border-orange-700 hover:shadow-md transition-all transform hover:-translate-y-1"
            >
              <div className="flex items-center gap-3">
                <div className="text-3xl md:text-4xl">⚙️</div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-sm md:text-base text-gray-100 group-hover:text-orange-400 transition-colors mb-0.5 truncate">
                    Configuration
                  </h3>
                  <p className="text-[10px] md:text-xs text-gray-400 leading-tight line-clamp-1">
        ...
        {status.isConnected && (
          <div className="bg-gradient-to-br from-green-900/20 via-emerald-900/20 to-blue-900/20 rounded-xl border-l-4 border-green-600 p-3 md:p-4 shadow-sm">
            {/* Header */}
            <h4 className="text-xs md:text-sm font-bold text-green-400 uppercase tracking-wide mb-2 md:mb-3 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 md:gap-4 mb-4 md:mb-5">
              <div className="text-[10px] md:text-xs leading-snug">
                <span className="font-bold text-green-300">💬 Conversations:</span>{' '}
                <span className="text-gray-300">{(stats as any).todayConversations || 0} hari ini ({stats.active || 0} active)</span>
              </div>
              <div className="text-[10px] md:text-xs leading-snug">
                <span className="font-bold text-purple-300">📨 Messages:</span>{' '}
                <span className="text-gray-300">{(stats as any).todayMessages || status.todayMessages || 0} hari ini</span>
              </div>
              <div className="text-[10px] md:text-xs leading-snug">
                <span className="font-bold text-blue-300">🤖 AI Automation:</span>{' '}
                <span className="text-gray-300">
                  {status.aiResponseRate >= 80 ? (
                    <span className="text-green-400 font-semibold">Excellent ({status.aiResponseRate}%)</span>
                  ) : status.aiResponseRate >= 60 ? (
                    <span className="text-amber-400 font-semibold">Good ({status.aiResponseRate}%)</span>
                  ) : status.aiResponseRate > 0 ? (
                    <span className="text-red-400 font-semibold">Perlu improve ({status.aiResponseRate}%)</span>
                  ) : (
                    <span className="text-gray-500 font-medium">No Data</span>
                  )}
                </span>
              </div>
              <div className="text-[10px] md:text-xs leading-snug">
                <span className="font-bold text-orange-300">⚡ Response Speed:</span>{' '}
                <span className="text-gray-300">
                  {stats.avgResponseTime > 0 ? (
                    stats.avgResponseTime < 60 ? (
                      <span className="text-green-400 font-semibold">Cepat ({formatResponseTime(stats.avgResponseTime)})</span>
                    ) : (
                      <span className="text-amber-400 font-semibold">Slow ({formatResponseTime(stats.avgResponseTime)})</span>
                    )
                  ) : (
                    <span className="text-gray-500 font-medium">No Data</span>
                  )}
              ...
              <div className="text-[10px] md:text-xs leading-snug">
                <span className="font-bold text-green-300">💰 Time Saved:</span>{' '}
                <span className="text-gray-300">~<span className="font-semibold text-green-400">{Math.round(((stats as any).todayMessages || status.todayMessages || 0) * (status.aiResponseRate / 100) * 1.5)} menit</span> hari ini</span>
              </div>
            </div>

            {/* Performance Status - Simplified */}
            <div className="border-t border-green-800/50 pt-2 md:pt-3">
              <p className="text-[10px] md:text-xs font-semibold text-gray-300 mb-2">📊 Performance Status:</p>
                  ...
                  return (
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] md:text-xs text-gray-300">
                        ...
                        <span className={isExcellent ? 'text-green-400' : isGood ? 'text-amber-400' : 'text-red-400'}>
        ...
        {!status.isConnected && (
          <div className="bg-[#2a2a2a] p-6 rounded-xl shadow-sm border border-[#3a3a3a] mb-3">
            <h2 className="text-lg font-bold text-white mb-4">Quick Setup Guide</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-green-900/40 text-green-400 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 border border-green-800">1</div>
                <div>
                  <h3 className="font-semibold text-gray-200 text-sm">Connect WhatsApp</h3>
                  <p className="text-xs text-gray-400">Scan QR code</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-blue-900/40 text-blue-400 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 border border-blue-800">2</div>
                <div>
                  <h3 className="font-semibold text-gray-200 text-sm">Configure AI</h3>
                  <p className="text-xs text-gray-400">Customize personality</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-purple-900/40 text-purple-400 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 border border-purple-800">3</div>
                <div>
                  <h3 className="font-semibold text-gray-200 text-sm">Add Staff</h3>
                  <p className="text-xs text-gray-400">Grant access</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-orange-900/40 text-orange-400 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 border border-orange-800">4</div>
                <div>
                  <h3 className="font-semibold text-gray-200 text-sm">Go Live! 🚀</h3>
                  <p className="text-xs text-gray-400">Ready 24/7</p>
                </div>
              </div>
            </div>
          </div>
