    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div className="p-4 text-center">
          ...
          <p className="text-sm text-gray-700 font-medium">No active subscription</p>
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      <div className="px-3 py-2 border-b border-gray-100 flex items-center justify-between">
        ...
        <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold ${getStatusColor()}`}>
          {getStatusLabel()}
        </span>
      </div>
      ...
      <div className="p-3 space-y-3">
        ...
        <div className="text-center">
          ...
          <p className="text-sm font-semibold text-gray-900">{formatDate(subscription.currentPeriodEnd)}</p>
          <p className="text-xs text-blue-600 font-medium mt-0.5">{days > 0 ? `${days} hari tersisa` : 'Berakhir'}</p>
        </div>
        ...
        {days > 0 && days <= 30 && (
          <div className="bg-amber-50 rounded-lg p-2 border border-amber-100 text-center">
            <p className="text-[10px] text-amber-700 font-medium">Segera berakhir! Hubungi admin.</p>
          </div>
        )}
