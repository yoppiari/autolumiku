    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          <Link
            href={`/catalog/${slug}/vehicles/${vehicle.id}`}
            className="flex-1 px-4 py-2 text-sm text-center bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
          >
            Lihat Detail
          </Link>
          <button
