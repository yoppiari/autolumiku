    ...
    <footer className="bg-muted text-muted-foreground mt-auto border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-foreground">{tenant.name}</h3>
            <p className="mb-4">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-foreground">Hubungi Kami</h4>
            <div className="space-y-3">
              {tenant.phoneNumber && (
                <div className="flex items-center gap-2">
                  <FaPhone className="text-primary" />
                  <a href={`tel:${tenant.phoneNumber}`} className="hover:text-foreground transition-colors">
                    {tenant.phoneNumber}
                  </a>
                </div>
              )}
              ...
              {tenant.email && (
                <div className="flex items-center gap-2">
                  ...
                  <a href={`mailto:${tenant.email}`} className="hover:text-foreground transition-colors">
                    {tenant.email}
                  </a>
                </div>
              )}
          ...
          {/* Address */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-foreground">Lokasi</h4>
            {fullAddress && (
